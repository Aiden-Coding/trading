            ...
            if (CollectionUtils.isNotEmpty(ret.getData())) {
                for (Map<String, Object> dataItem : ret.getData()) {
                    try {
                        ...
                        queryWrapper.eq(StockInfo::getCode, (String) dataItem.get("A股代码"));
                        ...
                        stockInfo.setCode((String) dataItem.get("A股代码"));

                        if (Objects.nonNull(dataItem.get("A股上市日期"))) {
                            Date date = DateUtils.parseDate((String) dataItem.get("A股上市日期"),"yyyy-MM-dd");
                            // 将时间戳转换为 Instant 对象
                        ...
                        stockInfo.setName((String) dataItem.get("A股简称"));
